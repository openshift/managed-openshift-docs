...
== Google group and roles

The `sd-sre-platform-gcp-access@redhat.com` Google group is granted access to the GCP project to allow Red Hat Site Reliability Engineering (SRE) access to the console for emergency troubleshooting purposes.
