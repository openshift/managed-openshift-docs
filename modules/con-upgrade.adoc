...
[NOTE]
====
Complete object store backups are taken prior to upgrading the cluster.
====
...
Should something go wrong during a cluster upgrade, the cluster will trigger an alert. The alert will engage the SRE team, who will investigate the alert and respond accordingly.
