...
[id="osd-private-cluster"]
:context: osd-private-cluster
...
include::modules/osd-enable-private-cluster-new.adoc[leveloffset=+1]

include::modules/osd-enable-private-cluster-existing.adoc[leveloffset=+1]

include::modules/osd-enable-public-cluster.adoc[leveloffset=+1]
