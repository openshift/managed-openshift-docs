...
:context: rosa-worker-nodes

= Managing worker nodes

[role="_abstract"]
This section describes how to manage worker nodes with {product-title}.
...
include::assemblies/rosa-service-definition.adoc[leveloffset=+1]
